...
|------|-------------|------|---------|:--------:|
| <a name="input_azs"></a> [azs](#input\_azs) | Liste des AZ a utiliser (minimum 2) | `list(string)` | <pre>[<br/>  "eu-west-3a",<br/>  "eu-west-3b"<br/>]</pre> | no |
| <a name="input_bastion_allowed_cidr"></a> [bastion\_allowed\_cidr](#input\_bastion\_allowed\_cidr) | CIDR autorise a se connecter en SSH au bastion | `string` | `"0.0.0.0/0"` | no |
| <a name="input_environment"></a> [environment](#input\_environment) | Environnement de deploiement | `string` | n/a | yes |
| <a name="input_project_name"></a> [project\_name](#input\_project\_name) | Prefixe applique aux noms de ressources | `string` | n/a | yes |
| <a name="input_vpc_cidr"></a> [vpc\_cidr](#input\_vpc\_cidr) | CIDR du VPC (doit etre un /16 ou /20) | `string` | n/a | yes |
